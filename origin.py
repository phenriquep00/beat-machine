...
'''
hi_hat = mixer.Sound('../../Downloads/beatMaker/beatMaker/sounds/hi hat.WAV')
snare = mixer.Sound('../../Downloads/beatMaker/beatMaker/sounds/snare.WAV')
kick = mixer.Sound('../../Downloads/beatMaker/beatMaker/sounds/kick.WAV')
crash = mixer.Sound('../../Downloads/beatMaker/beatMaker/sounds/crash.wav')
clap = mixer.Sound('../../Downloads/beatMaker/beatMaker/sounds/clap.wav')
tom = mixer.Sound("../../Downloads/beatMaker/beatMaker/sounds/tom.WAV")
...
load_menu = False
saved_beats = []
file = open('../../Downloads/beatMaker/beatMaker/saved_beats.txt', 'r')
for line in file:
        ...
        if event.type == pygame.MOUSEBUTTONUP and not save_menu and not load_menu:
            ...
            if save_menu:
                if saving_button.collidepoint(event.pos):
                    file = open('../../Downloads/beatMaker/beatMaker/saved_beats.txt', 'w')
